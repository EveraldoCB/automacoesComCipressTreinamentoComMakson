# 🚀 GUIA COMPLETO - PROJETO CYPRESS API AUTOMATION
...
### **🧪 TESTES E COMANDOS CUSTOMIZADOS**
- **Arquivo de testes**: `cypress/e2e/frete-calculo-v3-detalhes.cy.js`
- **Comandos customizados**: `cypress/support/commands.js`
- **Sistema de mocks**: Inteligente com fallback para API real
- **Tags implementadas**: `cenariosPositivos`, `cenariosNegativos`, `smoke`, `validation`
